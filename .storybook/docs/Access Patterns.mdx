...
| Item     |         PK         |                SK | Access Pattern    |
| -------- | :----------------: | ----------------: | ----------------- |
| Tag      | PTAG#<ParentTagID> | TAG#<ActualTagID> | Pull Tag          |
| Tag      | PTAG#<ParentTagID> |                NA | Pull Tag Children |
| TagStack |  TAGSTACK#<TagID>  |   TAGSTACK#<TagID | Pull Tag Stack    |
