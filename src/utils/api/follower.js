...
const getUserTagFollower = (parentTagId, tagId, userId) => {
  return fetch('http://localhost:3080/api/tag_user_follower/' + parentTagId + '/' + tagId + '/' + userId, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json'
    }
...
export { createUserTagFollower, getUserTagFollower, getTagsUserFollows, deleteUserTagFollower }
